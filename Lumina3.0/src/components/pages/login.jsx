          ...
          <div className="col divDireita">
            <div className="justify-content-start bemVindo">
              ...
              <div className="row justify-content-center">
                <button type="button" className="btn btn-light col-sm-8 btnLogin">
              ...
              <div className="row justify-content-center">
                <button type="button" className="btn btn-light col-sm-8 btnLogin">
                  ...
                  </svg> Fazer login com o Facebook
                </button>
              </div>
              <div className="row justify-content-center">
                <button type="button" className="btn btn-light col-sm-8 btnLogin">
                  ...
                  </svg> Fazer login com o Twitter-X
                </button>
              </div>
              ...
              <form className="d-flex justify-content-center bemVindo">
                <div className="col-sm-8">
                  <div className="mb-3">
                    <label htmlFor="loginUserName" className="form-label"></label>
                    <input 
                      type="text" 
                  ...
                  <div className="mb-3">
                    <label htmlFor="loginPassword" className="form-label"></label>
                    <input 
                      type="password" 
                      className="form-control" 
                      placeholder="Senha" 
                  ...
                  <div className="row justify-content-center">
                    <button type="submit" className="btn btn-success col-sm-4">LOGIN</button>
                  </div>
                </div>
              </form>
            </div>
              ...
              <div className="formularioCadastro">
                ...
                <div className="col-md-12 inputCadastro">
                  ...
                  <div className="row mb-3">
                    <label className="col-sm-2 col-form-label"></label>
                    <div className="col-sm-8">
                      <input type="email" className="form-control" placeholder="✉️Digite seu email"/>
                    </div>
                  </div>
                  <div className="row mb-3">
                    <label className="col-sm-2 col-form-label"></label>
                  ...
                  <div className="row mb-3">
                    <label className="col-sm-2 col-form-label"></label>
                    <div className="col-sm-8">
                      <input type="password" className="form-control" placeholder="🗝️Confirme sua senha"/>
                    </div>
                  </div>
                  <div className="row justify-content-center">
                    <button type="button" className="btn btn-success col-sm-5">Cadastrar</button>
                  </div>
                </div>
              </div>
            </div>
